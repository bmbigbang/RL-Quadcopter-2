...
class Actor:
    ...
    def __init__(self, state_size, action_size, action_low, action_high, actor_learn_rate=0.00001):
    ...
    def build_model(self):
        ...
        raw_actions = layers.Dense(self.action_size, activation='sigmoid',
        ...
        optimizer = optimizers.Adam(lr=self.actor_learn_rate)
        updates_op = optimizer.get_updates(params=self.model.trainable_weights, constraints={}, loss=loss)
...
class Critic:
    ...
    def build_model(self):
        ...
        net = layers.merge([net_states, net_actions], mode='concat')
        ...
        optimizer = optimizers.Adam(lr=self.critic_learn_rate)
